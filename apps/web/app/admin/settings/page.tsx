...
export default function Settings() {
  ...
  return (
    <AdminShell active="Settings" title="Settings" subtitle="Live AgencyOS configuration and environment status.">
      <div className="split">
        <Card title="Workspace">
          <div className="detail">
            <div className="kv"><b>Agency name</b><span>RCV Agency</span></div>
            <div className="kv"><b>Workspace</b><span>AgencyOS</span></div>
            <div className="kv"><b>Environment</b><span>{process.env.VERCEL_ENV || 'local'}</span></div>
          </div>
        </Card>
        <Card title="Security">
          <div className="detail">
